...
var OneBook3D = {
	...
	initWithData:function(FRDATA){
		...
		this.LNG = {
			...
			hlpGoToHomelink:['Mở trang chính','Открыть домашнюю страницу'],
			hlpClickToOpen:['Chạm để mở sách','Открой меня'],
			hlpUseMousewheel:['Có thể con lăn chuột để lật trang','Используйте колесо мыши<br>для листания'],
			hlpUseMousewheelGL:[['Có thể con lăn chuột','để lật trang'],['Используйте колесо','мыши для листания']],
			askSaveImage:['Select the page to save, please','Какое изображение сохранить?'],
			askSaveLinks:['<a href="#">Trái</a> hoặc <a href="#">Phải</a>','<a href="#">Левое</a> или <a href="#">Правое</a>']
		};
